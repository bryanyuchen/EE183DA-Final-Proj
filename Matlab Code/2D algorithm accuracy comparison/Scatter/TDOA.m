...
measurement_noise_TD1 = 0.0143;  % measurement noise between microphones 1 and 2 (refers to time delay in milliseconds)
measurement_noise_TD2 = 0.0143;  % measurement noise between microphones 2 and 3 (refers to time delay in milliseconds)
measurement_noise_TD3 = 0.0143;  % measurement noise between microphones 1 and 3 (refers to time delay in milliseconds)
